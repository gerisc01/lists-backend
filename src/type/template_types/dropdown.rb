  ...
  class Dropdown
    ...
    def self.field_def_validation(field)
      ...
      if list_options
        ...
        raise Schema::ValidationError.new("Invalid list_options: List '#{list_id}' cannot be found") if !list
      end
    end
    ...
    def self.type_match?(value)
      return value.is_a?(String) || value.is_a?(Integer)
    end
